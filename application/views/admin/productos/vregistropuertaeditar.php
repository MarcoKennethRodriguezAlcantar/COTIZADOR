	...
	<div class="col-md-12">
        ...
        <?php
                ...
                foreach ($p as $fila) {
                    $i = $i + 1;         
        ?>
        <form class="form-horizontal" action="<?php echo base_url(); ?>cadmin/updatepuerta" method="POST" enctype="multipart/form-data">
        	<input id="id" name="id" type="hidden" value="<?php echo $fila->idpuertas ?>">
	        	<div class="box-body">
